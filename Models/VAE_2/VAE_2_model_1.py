...
enc_conv_layer_6 = tfkl.Conv2D(filters=filters_number*4, kernel_size=3, strides=2, activation='relu', name="conv_layer_6")(enc_conv_layer_5)
...
dec_convT_layer_5 = tfkl.Conv2DTranspose(filters=filters_number*4, kernel_size=3, strides=2, padding='same', activation='relu', name="convT_layer_5")(dec_convT_layer_4)
dec_convT_layer_6 = tfkl.Conv2DTranspose(filters=filters_number*4, kernel_size=3, strides=1, padding='valid', activation='relu', name="convT_layer_6")(dec_convT_layer_5)
