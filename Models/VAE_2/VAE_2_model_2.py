...
enc_conv_layer_6 = tfkl.Conv2D(filters=filters_number*2, kernel_size=3, strides=2, activation='relu',padding="same", name="conv_layer_6")(enc_conv_layer_5)
...
dec_dense_layer = tfkl.Dense(units=24 * 24 * filters_number*2, activation=tf.nn.relu)(decoder_input_layer)
dec_reshape_layer = tfkl.Reshape(target_shape=(24, 24, filters_number*2))(dec_dense_layer)
