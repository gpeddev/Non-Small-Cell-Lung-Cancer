...
dec_convT_layer_1 = tfkl.Conv2DTranspose(filters=filters_number*4, kernel_size=3, strides=2, padding="same", activation='relu', name="convT_layer_1")(dec_reshape_layer)
dec_convT_layer_2 = tfkl.Conv2DTranspose(filters=filters_number*4, kernel_size=3, strides=1, padding='valid', activation='relu', name="convT_layer_2")(dec_convT_layer_1)
