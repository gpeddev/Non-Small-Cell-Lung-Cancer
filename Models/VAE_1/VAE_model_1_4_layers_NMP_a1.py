...
dec_convT_layer_3 = tfkl.Conv2DTranspose(filters=filters_number, kernel_size=3, strides=1, padding='same', activation='relu', name="convT_layer_3")(dec_convT_layer_2)
...
dec_convT_layer_5 = tfkl.Conv2DTranspose(filters=1, kernel_size=3, strides=1, padding='valid', activation='relu', name="convT_layer_5")(dec_convT_layer_4)
