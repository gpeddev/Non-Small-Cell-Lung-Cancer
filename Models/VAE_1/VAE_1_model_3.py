...
enc_conv_layer_4 = tfkl.Conv2D(filters=filters_number*4, kernel_size=3, strides=2, activation='relu', name="conv_layer_4")(enc_conv_layer_3)
...
dec_dense_layer = tfkl.Dense(units=32 * 32 * 128, activation=tf.nn.relu)(decoder_input_layer)
dec_reshape_layer = tfkl.Reshape(target_shape=(32, 32, 128))(dec_dense_layer)
...
dec_convT_layer_2 = tfkl.Conv2DTranspose(filters=filters_number*3, kernel_size=3, strides=2, padding='same', activation='relu', name="convT_layer_2")(dec_convT_layer_1)
