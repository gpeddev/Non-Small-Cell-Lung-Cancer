...
dec_dense_layer = tfkl.Dense(units=63 * 63 * 32, activation=tf.nn.relu)(decoder_input_layer)
dec_reshape_layer = tfkl.Reshape(target_shape=(63, 63, 32))(dec_dense_layer)
