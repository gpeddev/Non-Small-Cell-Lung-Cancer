...
enc_conv_layer_2 = tfkl.Conv2D(filters=filters_number, kernel_size=3, strides=1, activation='relu', padding="same", name = "conv_layer_2")(enc_conv_layer_1)
...
enc_conv_layer_5 = tfkl.Conv2D(filters=filters_number*2, kernel_size=3, strides=1, activation='relu', padding="same", name = "conv_layer_5")(enc_conv_layer_4)
enc_conv_layer_6 = tfkl.Conv2D(filters=filters_number*2, kernel_size=3, strides=2, activation='relu', name="conv_layer_6")(enc_conv_layer_5)
...
dec_convT_layer_1 = tfkl.Conv2DTranspose(filters=filters_number*2, kernel_size=3, strides=1, padding="valid", activation='relu', name="convT_layer_1")(dec_reshape_layer)
...
dec_convT_layer_3 = tfkl.Conv2DTranspose(filters=filters_number*2, kernel_size=3, strides=2, padding='same', activation='relu', name="convT_layer_3")(dec_convT_layer_2)
...
dec_convT_layer_5 = tfkl.Conv2DTranspose(filters=filters_number, kernel_size=3, strides=1, padding="same", activation='relu', name="convT_layer_5")(dec_convT_layer_4)
...
early_stopping_training_db = tfk.callbacks.EarlyStopping(monitor="loss",
                                                         ...
                                                         verbose=2,
                                                         restore_best_weights=True)
tf.keras.utils.plot_model(VAE, to_file="./vae_1_model_2.png", show_shapes=False, expand_nested=True)
