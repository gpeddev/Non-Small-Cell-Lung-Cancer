...
enc_conv_layer_1 = tfkl.Conv2D(filters=128, kernel_size=3, strides=2, activation='relu', name="conv_layer_1")(encoder_input_layer)
enc_conv_layer_2 = tfkl.Conv2D(filters=128, kernel_size=3, strides=1, activation='relu', name="conv_layer_2")(enc_conv_layer_1)
enc_conv_layer_3 = tfkl.Conv2D(filters=128, kernel_size=3, strides=2, activation='relu', name="conv_layer_3")(enc_conv_layer_2)
enc_conv_layer_4 = tfkl.Conv2D(filters=128, kernel_size=3, strides=2, activation='relu', name="conv_layer_4")(enc_conv_layer_3)
enc_conv_layer_5 = tfkl.Conv2D(filters=128, kernel_size=3, strides=1, activation='relu', name="conv_layer_5")(enc_conv_layer_4)
enc_conv_layer_6 = tfkl.Conv2D(filters=128, kernel_size=3, strides=2, activation='relu', name="conv_layer_6")(enc_conv_layer_5)
...
dec_convT_layer_1 = \
    tfkl.Conv2DTranspose(filters=128, kernel_size=2, strides=2, padding="same", activation='relu', name="convT_layer_1")(dec_reshape_layer)
dec_convT_layer_2 = \
    tfkl.Conv2DTranspose(filters=128, kernel_size=2, strides=1, padding="valid", activation='relu', name="convT_layer_2")(dec_convT_layer_1)
dec_convT_layer_3 = \
    tfkl.Conv2DTranspose(filters=128, kernel_size=2, strides=2, padding='same', activation='relu', name="convT_layer_3")(dec_convT_layer_2)
dec_convT_layer_4 = \
...
dec_convT_layer_5 = \
    tfkl.Conv2DTranspose(filters=128, kernel_size=2, strides=1, padding='valid', activation='relu', name="convT_layer_5")(dec_convT_layer_4)
dec_convT_layer_6 = \
    tfkl.Conv2DTranspose(filters=128, kernel_size=2, strides=2, padding='same', activation='relu', name="convT_layer_6")(dec_convT_layer_5)
dec_convT_layer_7 = \
