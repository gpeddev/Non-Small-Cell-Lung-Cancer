...
dec_convT_layer_2 = tfkl.Conv2DTranspose(filters=filters_number*2, kernel_size=3, strides=2, padding='same', activation='relu', name="convT_layer_2")(dec_convT_layer_1)
